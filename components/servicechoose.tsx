export default function ServiceChoose() {
    ...
    return (
        ...
        <div className="text-black flex flex-col py-2 px-4  max-w-[1050px] mx-auto">
            <h1 className=" text-center md:mt-4 font-bold mb-5 md:text-3xl text-xl tracking-wide">Want to Know More?</h1>
        
            <p className=" leading-normal  text-center font-medium md:text-xl text-lg line tracking-wide py-8"> Want to know more? Contact us at <span className="underline">services@darkmattergames.net</span> to explore how our expertise can elevate your gaming and digital endeavors. Join us in shaping the future of interactive experiences!</p>
